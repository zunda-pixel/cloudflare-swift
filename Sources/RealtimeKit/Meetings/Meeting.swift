...
public struct Meeting: Codable, Sendable, Identifiable {
  ...
  public init(from decoder: any Decoder) throws {
    ...
    self.preferredRegion = try container.decodeIfPresent(
      PreferredRegion.self,
      forKey: .preferredRegion
    )
    ...
    self.recordingConfig = try container.decodeIfPresent(
      RecordConfig.self,
      forKey: .recordingConfig
    )
