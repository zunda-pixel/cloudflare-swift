...
struct AAAARecordTests {
    ...
    func testInvalidIPv6Addresses() {
        ...
        for address in invalidAddresses {
            #expect(AAAARecord.isValidIPv6Address(address) == false, "Address \(address) should be invalid")
    ...
    func testIPv6EdgeCases() {
        ...
        for (address, expected) in edgeCases {
            #expect(AAAARecord.isValidIPv6Address(address) == expected, "Address \(address) validation should be \(expected)")
        }
    }
    ...
    func testAAAARecordJSONSerialization() throws {
        let record = AAAARecord(
            ...
            createdOn: Date(timeIntervalSince1970: 1609459200), // 2021-01-01 00:00:00 UTC
            modifiedOn: Date(timeIntervalSince1970: 1609545600)  // 2021-01-02 00:00:00 UTC
        )
