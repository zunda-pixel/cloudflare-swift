...
struct CAARecordTests {
  ...
  func testCAAValueValidationForIssue() {
    ...
    for tag in ["issue", "issuewild"] {
      for value in validValues {
        #expect(
          CAARecord.isValidCAAValue(value, for: tag) == true,
          "Value '\(value)' should be valid for tag '\(tag)'")
        ...
        #expect(
          record.isValidValue == true,
          "Record with value '\(value)' should be valid for tag '\(tag)'")
      }
    }
    ...
    for tag in ["issue", "issuewild"] {
      for value in invalidValues {
        #expect(
          CAARecord.isValidCAAValue(value, for: tag) == false,
          "Value '\(value)' should be invalid for tag '\(tag)'")
      }
    }
  }
  ...
  func testCAAValueValidationForIODEF() {
    ...
    for value in validValues {
      #expect(
        CAARecord.isValidCAAValue(value, for: "iodef") == true,
        "Value '\(value)' should be valid for iodef tag")
    ...
    for value in invalidValues {
      #expect(
        CAARecord.isValidCAAValue(value, for: "iodef") == false,
        "Value '\(value)' should be invalid for iodef tag")
    }
  }
