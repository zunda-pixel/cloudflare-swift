...
struct NSRecordTests {
  ...
  func testValidNSNameServers() {
    ...
    for nameServer in validNameServers {
      #expect(
        NSRecord.isValidHostname(nameServer) == true, "Name server '\(nameServer)' should be valid")
      ...
      #expect(
        record.isValidNameServer == true, "Record with name server '\(nameServer)' should be valid")
    }
  }
  ...
  func testInvalidNSNameServers() {
    ...
    for nameServer in invalidNameServers {
      #expect(
        NSRecord.isValidHostname(nameServer) == false,
        "Name server '\(nameServer)' should be invalid")
      ...
      #expect(
        record.isValidNameServer == false,
        "Record with name server '\(nameServer)' should be invalid")
    }
  }
